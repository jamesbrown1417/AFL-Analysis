---
title: "Season Team Stats Report"
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Fantasy Points` = mean_fantasy_points)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Kicks` = mean_kicks)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Handballs` = mean_handballs)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Disposals` = mean_disposals)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Marks` = mean_marks)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Tackles` = mean_tackles)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Goals` = mean_goals)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Behinds` = mean_behinds)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Hitouts` = mean_hitouts)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Frees For` = mean_freesFor)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Frees Against` = mean_freesAgainst)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Contested Marks` = mean_contestedMarks)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Uncontested Marks` = mean_uncontestedMarks)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Contested Possessions` = mean_contestedPossessions)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Uncontested Possessions` = mean_uncontestedPossessions)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Clangers` = mean_clangers)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Turnovers` = mean_turnovers)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Inside 50s` = mean_inside50s)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Rebound 50s` = mean_rebound50s)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Disposal Efficiency` = mean_disposalEfficiency)
...
combined_stats_table %>%
  ...
  rename(Team = team, `Avg Kick Efficiency` = mean_kick_efficiency)
